...
if __name__ == '__main__':
    coordinates = uf.get_coordinate(3, 0.0)
    mesh = cf.from_coords_to_mesh(coordinates, noise, element_type = "TRI")
    del coordinates
    ...
    #     var.uv, var.vv, var.pv = sol.cal_node_value(var.uc, var.vc, var.pc, mesh, cw, u_lid, v_lid)
    ...
    #     var.mdotf = sol.cal_massflow_face(mesh, var.uc, var.vc, var.pc, var.pf, ap, fw)
